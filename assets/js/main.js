...
const blurHeader = () =>{
    ...
    // When the scroll is greater than viewport height, add the blur-header class to
...
sr.reveal(`.follow__data, .follow__content-1 img, .health__rate, .health__course`,{interval: 100});